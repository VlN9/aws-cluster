...
export MONITORING_ELB=`kubectl get service -n monitoring | grep -Ewo "\w[-]*.\w{2}-\w{4,10}-[1-3].elb.amazonaws.com"`
export APP_ELB=`kubectl get service | grep -Ewo "\w[-]*.\w{2}-\w{4,10}-[1-3].elb.amazonaws.com"`
